...
class Unet(nn.Module):
    def __init__(
        ...
        # only one attention block per down block
        # each down block has the two conv blocks, then attention + residual, plus downsample
        # then finally a convolution back to the original dimension
